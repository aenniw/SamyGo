...
void cfg_parseargs(int argc, const char **argv) {
    ...
    for (i = 1; i < argc; i++) {
        ...
        if (txt[0] == '-') {
            ...
            if (!strcmp(txt, "-joy0")) {
                if (argc <= (++i)) break;
                sscanf(argv[i], "%i,%i,%i,%i", &cfg_buttonmap[0][0], &cfg_buttonmap[0][1], &cfg_buttonmap[0][2],
                       &cfg_buttonmap[0][3]);
            }
            if (!strcmp(txt, "-joy1")) {
                if (argc <= (++i)) break;
                sscanf(argv[i], "%i,%i,%i,%i", &cfg_buttonmap[1][0], &cfg_buttonmap[1][1], &cfg_buttonmap[1][2],
                       &cfg_buttonmap[1][3]);
            }
            if (!strcmp(txt, "-joy2")) {
                if (argc <= (++i)) break;
                sscanf(argv[i], "%i,%i,%i,%i", &cfg_buttonmap[2][0], &cfg_buttonmap[2][1], &cfg_buttonmap[2][2],
                       &cfg_buttonmap[2][3]);
            }
            if (!strcmp(txt, "-joy3")) {
                if (argc <= (++i)) break;
                sscanf(argv[i], "%i,%i,%i,%i", &cfg_buttonmap[3][0], &cfg_buttonmap[3][1], &cfg_buttonmap[3][2],
                       &cfg_buttonmap[3][3]);
            }
