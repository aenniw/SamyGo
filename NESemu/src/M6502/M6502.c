...
#define MC_Ix(Rg)    K.B.l=Op6502(R->PC.W++)+R->X;K.B.h=0; \
                        Rg.B.l=Op6502(K.W++);Rg.B.h=Op6502(K.W&255) /* Fixed wraparound */
#define MC_Iy(Rg)    K.B.l=Op6502(R->PC.W++);K.B.h=0;  /* Fixed wraparound */ \
                        Rg.B.l=Rd6502(K.W);Rg.B.h=Rd6502(((K.B.l+1)&255)|K.B.h);    \
            Rg.W+=R->Y
